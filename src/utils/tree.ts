...
export function optionalGetterForProp(prop: string | number): OptionalValueGetter {
...
class TreeNode {
  ...
  sortTreeNodes(columns: ITableColumn[], dirs: ISortPropDir[]) {
  ...
  flatten(f: () => void, recursive: boolean, lazyTree: boolean = false) {
